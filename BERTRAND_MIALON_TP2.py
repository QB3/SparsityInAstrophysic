...
hardReconst = reconstruction(y, nLevel, h, k, "hardThrd")
plt.figure()
...
Hx = Hx + np.random.normal(0,sigma, (n,n))
plt.figure()
...
def getGradConvol(alpha, H, y, nLevel, h):
...
#fonction pour créer un masque avec p coefficients nuls choisi au hasard
def getMask(p, n):
